...
import com.liverm0r.test.business.currency.transactions.exchange.ExchangeImp;
...
import static com.liverm0r.test.common.NAMES.GBP;

public class ProductsInPoundsFabric implements IProductsFabric {


    private ExchangeImp mExchanger;
